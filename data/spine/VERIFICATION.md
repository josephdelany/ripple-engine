...
| `kuwait_oil_fires_1991` | S1 `govinfo.gov/.../PPP-1991-book1-doc-pg165.htm` | that this is "Remarks on the Persian Gulf Conflict", February 22 1991, 10:43 a.m., and that the President said Iraq was destroying Kuwait's oil wells | re-fetched by the reviewer | **matches exactly** — title, date-and-time line, and the quotation "He is wantonly setting fires to and destroying the oil wells, the oil tanks, the export terminals, and other installations of that small country." This record's Wikipedia citation is properly replaced by a primary presidential document |
