...
| E | 13 | 0 | 10 | 3 | 0 |
| F | 10 | 2 | 8 | 0 | 0 |
| G_accident | 99 | 81 | 14 | 4 | 0 |
| **total** | **174** | **86** | **59** | **25** | **4** |

The §5 gate is counted over **A, B, C, D, E, F** only. G_accident declares `counts_toward_gate: false` (EXPOSURE_REGISTRATION Amendment 1) and that declaration is honoured, not overridden: a block saying its own rows do not count cannot carry the gate over the line. COMPLETE across **all** blocks including the excluded one is **86**, published here so the exclusion is visible rather than silent.
