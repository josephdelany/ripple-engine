# Dossier mid_4547_irn_irq_dispute — IRN IRQ dispute

```json
{
 "id": "mid_4547_irn_irq_dispute",
 "built_by": "session A",
 ...
 "primary": {
  ...
  "source": "mid",
  "source_id": "4547",
  "detail": "dispute 4547 IRN-IRQ 2010-05-12..2010-12-28 hihost 4",
...
COW Dyadic MID 4.03 (dyadic_mid_4.03.csv) record 4547 **IRN IRQ dispute**: dispute 4547 IRN-IRQ 2010-05-12..2010-12-28 hihost 4 trigdate 2010-05-12, termdate None, viol None, forout None. Page: https://correlatesofwar.org/data-sets/mids/
...
`python3 src/admit.py --dossier mid_4547_irn_irq_dispute --approved-by joe`. The code never runs it.
