# Dossier mid_4719_chn_ind_dispute — CHN IND dispute

```json
{
 "id": "mid_4719_chn_ind_dispute",
 "built_by": "session A",
 ...
 "primary": {
  ...
  "source": "mid",
  "source_id": "4719",
  "detail": "dispute 4719 CHN-IND 2013-04-15..2013-12-21 hihost 4",
...
COW Dyadic MID 4.03 (dyadic_mid_4.03.csv) record 4719 **CHN IND dispute**: dispute 4719 CHN-IND 2013-04-15..2013-12-21 hihost 4 trigdate 2013-04-15, termdate None, viol None, forout None. Page: https://correlatesofwar.org/data-sets/mids/
...
`python3 src/admit.py --dossier mid_4719_chn_ind_dispute --approved-by joe`. The code never runs it.
