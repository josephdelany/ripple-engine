# Dossier mid_4633_irq_tur_dispute — IRQ TUR dispute

```json
{
 "id": "mid_4633_irq_tur_dispute",
 "built_by": "session A",
 ...
 "primary": {
  ...
  "source": "mid",
  "source_id": "4633",
  "detail": "dispute 4633 IRQ-TUR 2014-06-02..2014-06-02 hihost 4",
...
COW Dyadic MID 4.03 (dyadic_mid_4.03.csv) record 4633 **IRQ TUR dispute**: dispute 4633 IRQ-TUR 2014-06-02..2014-06-02 hihost 4 trigdate 2014-06-02, termdate None, viol None, forout None. Page: https://correlatesofwar.org/data-sets/mids/
...
`python3 src/admit.py --dossier mid_4633_irq_tur_dispute --approved-by joe`. The code never runs it.
