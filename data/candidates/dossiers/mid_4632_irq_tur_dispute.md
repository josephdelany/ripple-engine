# Dossier mid_4632_irq_tur_dispute — IRQ TUR dispute

```json
{
 "id": "mid_4632_irq_tur_dispute",
 "built_by": "session A",
 ...
 "primary": {
  ...
  "source": "mid",
  "source_id": "4632",
  "detail": "dispute 4632 IRQ-TUR 2011-08-17..2013-02-21 hihost 4",
...
COW Dyadic MID 4.03 (dyadic_mid_4.03.csv) record 4632 **IRQ TUR dispute**: dispute 4632 IRQ-TUR 2011-08-17..2013-02-21 hihost 4 trigdate 2011-08-17, termdate None, viol None, forout None. Page: https://correlatesofwar.org/data-sets/mids/
...
`python3 src/admit.py --dossier mid_4632_irq_tur_dispute --approved-by joe`. The code never runs it.
