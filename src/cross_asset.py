...
ASSETS = [
    ...
    {"series": "fred.DEXCHUS",      "label": "CNY/USD",     "entity": "country.china",
     "kind": "price", "unit": "%"},
    # WS-S wider nodes: give more domains a fair shot at a validated ripple node (all keyless).
    {"series": "yf.platinum",       "label": "Platinum",    "entity": "commodity.platinum",
     "kind": "price", "unit": "%"},
    {"series": "yf.corn",           "label": "Corn",        "entity": "commodity.corn",
     "kind": "price", "unit": "%"},
    {"series": "yf.soybean",        "label": "Soybeans",    "entity": "commodity.soybean",
     "kind": "price", "unit": "%"},
    {"series": "yf.miners",         "label": "Gold miners", "entity": "macro.miners",
     "kind": "price", "unit": "%"},
    {"series": "yf.copper_miners",  "label": "Copper miners", "entity": "commodity.copper_miners",
     "kind": "price", "unit": "%"},
    {"series": "yf.freight",        "label": "Dry-bulk freight", "entity": "supplychain.freight",
     "kind": "price", "unit": "%"},
    {"series": "yf.tankers",        "label": "Product tankers", "entity": "supplychain.tankers",
     "kind": "price", "unit": "%"},
    {"series": "fred.DEXUSEU",      "label": "USD/EUR",     "entity": "macro.fx",
     "kind": "price", "unit": "%"},
    {"series": "fred.DEXJPUS",      "label": "JPY/USD",     "entity": "macro.fx",
     "kind": "price", "unit": "%"},
